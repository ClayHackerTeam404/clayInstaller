clear
echo "\033[34;1m Welcome To CLAY Hacker Team"
sleep 1
...
echo "\033[35;1m Silahkan Pilih Nomor Yang Mau Di Install"
...
cd Spammer-Grab
python2 spammer.py
echo "Untuk menjalankan tools spammer grab kalian ketik python2 spammer.py" | lolcat
fi
...
echo "Kalau ingin lihat lebih lengkap kalian copy link youtube ini https://www.youtube.com/channel/UCr8Ql1jGZ-rLXC6WQlT5H8g" | lolcat
fi
